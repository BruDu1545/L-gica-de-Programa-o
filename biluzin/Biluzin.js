...
function surfArray(array) {
    for (let surf = array.length - 1; surf > 0; surf--) {
        let s = Math.floor(Math.random() * (surf + 1));
        [array[surf], array[s]] = [array[s], array[surf]]
    }
    return array
}
        ...
        for (let j = 0; j < roomDefined.length; j++) {//repete na linha
            for (let i = 0; i < roomDefined[j].length; i++) {//repete na coluna
                if (rE == 1 || rE == 3 || rE == 5 || rE == 7) {
                    if (j == 1 || j == 3 || j == 5 || j == 7) {
                        if (i == 1 || i == 5) {
                            roomDefined[j][i] = (definedClass1[index1++])
                        } else if (i == 3 || i == 7) {
                            roomDefined[j][i] = (definedClass2[index2++])
                        } else if (i == 2 || i == 4 || i == 6 || i == 8) {
                            roomDefined[j][i] = (definedClass3[index3++])
                        }
                    } else {
                        if (i == 1 || i == 3 || i == 5 || i == 7) {
                            roomDefined[j][i] = (definedClass4[index4++])
                        } else if (i == 0 || i == 2 || i == 4 || i == 6 || i == 8) {
                            roomDefined[j][i] = (definedClass5[index5++])
                        }
                    }
                }else if (rE == 0 || rE == 2 || rE == 4 || rE == 6 || rE == 8) {
                    if (j % 2 !== 0) {
                        if (i % 2 !== 0) {
                            roomDefined[j][i] = (definedClass6[index6])
                        } else {
                            roomDefined[j][i] = (definedClass7[index7])
                        }
                    } else {
                        if (i % 2 !== 0) {
                            roomDefined[j][i] = (definedClass8[index8])
                        } else {
                            roomDefined[j][i] = (definedClass9[index9])
                        }
                    }
                }
            }
